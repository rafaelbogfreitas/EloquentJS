...
runRobot(VillageState.random(20), goalOrientedRobot);
...
function compareRobots(robot1, memory1, robot2, memory2) {
    ...
    for(let i = 0; i < 100; i++) {
  	...
  	tasks.forEach(task => {
      avgRobot1.push(runRobot(task, robot1, memory1));
      avgRobot2.push(runRobot(task, robot2, memory2));
    });
  
  	console.log({
      avgStepsRobot1: avgRobot1.reduce((acc, steps) => acc + steps, 0) / 100,
      avgStepsRobot2: avgRobot2.reduce((acc, steps) => acc + steps, 0) / 100,
    });
